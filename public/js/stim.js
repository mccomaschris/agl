...
/***/ "./resources/assets/js/controllers/flash-controller.js":
/*!*************************************************************!*\
  !*** ./resources/assets/js/controllers/flash-controller.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_this), "closeFlash", function () {
      _this.flashBox.style.opacity = '0';
    });
...
/***/ "./resources/assets/js/controllers/mobile-nav-controller.js":
/*!******************************************************************!*\
  !*** ./resources/assets/js/controllers/mobile-nav-controller.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
_defineProperty(_default, "targets", ['menu', 'open', 'close']);



/***/ }),

/***/ "./resources/assets/js/controllers/score-row-controller.js":
/*!*****************************************************************!*\
  !*** ./resources/assets/js/controllers/score-row-controller.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "countGross",
    value: function countGross(e) {
      var gross = 0;
      this.scoreInputTargets.forEach(function (el, i) {
    ...
    value: function update(e) {
      ...
      var formData = {
        absent: this.absentTarget.checked,
        weekly_winner: this.weeklyWinnerTarget.checked,
        substitute_id: this.substituteTarget.checked,
        hole_1: this.hole1Target.value,
        hole_2: this.hole2Target.value,
        hole_3: this.hole3Target.value,
        hole_4: this.hole4Target.value,
        hole_5: this.hole5Target.value,
        hole_6: this.hole6Target.value,
        hole_7: this.hole7Target.value,
        hole_8: this.hole8Target.value,
        hole_9: this.hole9Target.value,
        points: this.pointsInputTarget.value,
        official: this.officialTarget.value
      };
      fetch(this.data.get("url"), {
        ...
        _this.saveTarget.firstElementChild.classList.remove('opacity-0');

        _this.saveTarget.classList.remove("loader", "loader-green");

        if (response.status === 204) {
          _this.saveTarget.classList.remove("text-grey-400");

          _this.saveTarget.classList.add("text-red-500");
        } else {
          _this.saveTarget.classList.remove("text-red-500");

          _this.saveTarget.classList.add("text-grey-400");
        }
      });
    }
  }, {
...
_defineProperty(_default, "targets", ['absent', 'weeklyWinner', 'substitute', 'scoreInput', 'gross', 'pointsInput', 'container', 'save', 'hole1', 'hole2', 'hole3', 'hole4', 'hole5', 'hole6', 'hole7', 'hole8', 'hole9', 'official']);



/***/ }),

/***/ "./resources/assets/js/controllers/update-button-controller.js":
/*!*********************************************************************!*\
  !*** ./resources/assets/js/controllers/update-button-controller.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function update(e) {
      ...
      }, setTimeout(this.element.classList.remove('loader'), 5000));
    }
  }]);
...
/***/ "./resources/assets/js/controllers sync recursive \\.js$":
/*!*****************************************************!*\
  !*** ./resources/assets/js/controllers/ sync \.js$ ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var map = {
	"./flash-controller.js": "./resources/assets/js/controllers/flash-controller.js",
	"./mobile-nav-controller.js": "./resources/assets/js/controllers/mobile-nav-controller.js",
	"./score-row-controller.js": "./resources/assets/js/controllers/score-row-controller.js",
	"./update-button-controller.js": "./resources/assets/js/controllers/update-button-controller.js"
};
...
webpackContext.id = "./resources/assets/js/controllers sync recursive \\.js$";
...
var context = __webpack_require__("./resources/assets/js/controllers sync recursive \\.js$");
