<template>
    <tr>
        ...
        <td class="border-t px-1 py-4 text-center">
            <div class="relative">
                <select class="block appearance-none w-full bg-zinc-100 border border-zinc-300 text-zinc-600 p-2 rounded" v-model="points" @change="update"  @keydown.tab="update">
                   <option value=""></option>
        ...
        <td class="border-t px-1 py-4 text-center">
            <button :class="classes" @click="update">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current h-6 w-6 text-zinc-400 hover:text-green-500"><path d="M0 2C0 .9.9 0 2 0h14l4 4v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm5 0v6h10V2H5zm6 1h3v4h-3V3z"/></svg>
            </button>
        </td>
    </tr>
</template>
