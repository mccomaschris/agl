<x-main>
    ...
    <div class="flex items-center text-sm bg-grey-900 text-white px-4 lg:pr-8 py-4 lg:py-6 rounded shadow mb-6" role="alert">
        ...
        <div>
            ...
            <p class="hidden md:block -mt-2">For 2021 we are back to the original sand bunker rules. If you hit your ball in a bunker you must play from the sand. <strong>DO NOT</strong> remove it from the bunker before playing it.</p>
