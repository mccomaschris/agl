<x-main>
	<div class="flex items-center text-sm bg-grey-900 text-white px-4 lg:pr-8 py-4 lg:py-6 rounded shadow mb-6" role="alert">
        ...
        <div>
            <p class="md:block mt-3 text-lg">Vance Bunn had a hole in one on #6 2 years ago. Congrats Vance!</p>
            <p class="md:block mt-3">The Snowball Tournament is Sunday, April 7th at 1:00pm</p>
        </div>
    </div>
