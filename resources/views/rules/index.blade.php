...
<x-main>
    ...
    <div class="flex mx-0 lg:-mx-8 relative">
        <div class="w-full lg:w-3/4 px-0 lg:px-8">
            ...
            <p class="mb-3">Minimum age for a member is 25 years of age. Membership fees are $70 per year, which includes the $12 kitty for each "side game" played each week (alternating between closest to the pin, low putts and low net). Any ties during the weekly "side game" will be split between the winners. This fee must be paid prior to Snowball Tournament. A new member joining the League after the season has begun will be charged an entry fee based on $3.50 per week for the remainder of the weeks in the season. For instance, if he joins in the 5th week, he will be charged $56.00 for the remainder of the season.</p>
            ...
            <p class="mb-3">Play in the Appliance League is Match Play. You can read more about <a href="http://www.usga.org/rules/rules-and-decisions.html#!rule-02">Match Play on the USGA website</a>.</p>
            ...
            <p class="mb-3">Any missed matches must be made up within the current quarter of the schedule. All matches must be made up and scorecards <a href="mailto:mccomas.chris@gmail.com">sent to the webmaster</a> by Wednesday evening prior to the next quarter starting. If you miss Week 8, you have until the night before Week 11's Thursday play to make-up your match and send your scorecard to the website to ensure handicaps are updated and ready for Week 11.</p>
            <p class="mb-3">Opposing players are obligated to make every effort to accommodate the player who is missing the match. The proper handicap will be applied to the match that would be applied should the match be played at the scheduled date. If you pre-play a Thursday match and that regular Thursday match is rained out, your pre-play match is also considered rained out and is null and void.</p>
            <p class="mb-3">If during this time a player misses five matches he will be replaced immediately.</p>
            <p class="mb-3">In the event of medical issue, serious injury or illness, either to the player or a family member that needs their care, accommodations will be made to replace that player with a temporary player while his absence is required. Once the player is able to return to regular play, the temporary player will be released and the member will rejoin the League play.</p>
            <p class="mb-3">If a member of your foursome is not present at your appointed tee time, the next foursome will be allowed to tee off ahead of your group. Your foursome continues to get bumped back until your entire foursome is present. Once all of your group is present, you can tee off. If you know that you will not be able to play on a particular week, <strong>CALL OR TEXT YOUR OPPONENT</strong> and let them know. This saves us all time and trouble. Likewise, if you know that one of your group will not be present, your threesome can tee off at its appropriate time, assuming that all of you are there and ready to play.</p>
