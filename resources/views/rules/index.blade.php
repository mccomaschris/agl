...
<x-main>
    <x-slot name="header">
        <h1 class="text-center lg:text-left text-2xl lg:text-3xl mt-6 mb-4 tracking-tight">Appliance Golf League Rules</h1>
    </x-slot>
    ...
    <div class="flex mx-0 lg:-mx-8 relative">
        <div class="w-full lg:w-3/4 px-0 lg:px-8">
            ...
            <p class="mb-3">The League will elect a President-elect and Secretary each year at the dinner following the Individual League Championship.</p>
            <p class="mt-3">Duties of the <strong>President</strong>:</p>
            <ol class="mb-4 list-inside list-decimal pl-6 block">
                <li>Presides over the organizational meeting in March as well as any other meetings that may occur during the season</li>
                <li>He decides whether to play in the event of rain or other inclement conditions</li>
                <li>Determines how many will be attending the banquet at the end of the year and orders food, and organizes the banquet</li>
            </ol>
            ...
            <ol class="mb-4 list-inside list-decimal pl-6">
                <li>Sets up the League schedule, including weekly matches, Snowball Tournament, and year-end tournament</li>
            ...
            <p class="mb-3">Each team captain (the #1 player) will be assigned a team number. The #2 players will be drawn at random. The first #2 player will be assigned to Team 1, the second #2 player drawn will be assigned to Team 2, and so on. This will also be done for the #3 and #4 players.</p>
            <p class="mb-3">A schedule of matches will be provided to each player at the beginning of the season. Each player will eventually be paired w/ every other player in the league. The firsts 5 weeks will have the #1 and #2 players paired together and the #3 and #4 paired together. For the 5-10th weeks, the #1 and #3 are paired as are #2 and #4. For weeks 10-15, players #1 and #4 will be paired with #2 and #3 paired. For the last 5 weeks we will revert to the same pairings as the first five weeks.</p>
            ...
            <p class="mb-3">A player’s league handicap is figured as the difference between par (currently 37 on the front nine at Riviera) and the player’s average score. For example, if a player’s average score is 40, their handicap would be 3 (40-37=3). As league play continues, a handicap may be a fraction. Fractions greater than or equal to .5 are rounded up, less than .5 are rounded down. So, a handicap of 4.55 would become 5, while a handicap of 4.48 would become 4.</p>
            <p class="mb-3">To start the new season returning players’ handicaps will be based on the average of all their scores the prior season. New players joining at the beginning of the season will be the average of the scores that person has on the front 9 of Riviera or an honest assessment of his likely average score on the front 9 of Riviera.</p>
            <p class="mb-3">In season handicaps are recalculated every five weeks using the best 50% or better of each player’s scores. For example, if a player plays in all 10 matches the first two quarters of the season their handicap will be based on the average of their 5 best scores. If a player only plays in 9 matches in their first two quarters of the season their handicap will still be based on the average of their 5 best scores.</p>
            <p class="mb-3">The ranking of players (i.e., 1-4 players) will be based on the year-end handicap which is the best 50% or better of the scores.</p>
            ...
            <p class="mb-3">For the Team Playoffs and Individual League Championship, the best 10 scores of the entire season will be used. This HC will be used for any/all of the team playoffs (9-hole match-play) and the individual League Championship Tournament (18-holes stroke-play).</p>
            <p class="mb-3">HC for the League Championship at the end of the season will be 1.5 times the 9-hole HC. For example, a player w/ a HC of 4 will have a HC of 6 for the 18-hole tournament. A player w/ a HC of 7 will have a HC of 11 (7+3.5= 10.5 rounded to 11).</p>
            ...
            <p class="mb-3">Play in the Appliance League is Match Play. You can read more about <a href="http://www.usga.org/rules/rules-and-decisions.html#!rule-02"></a>Match Play on the USGA website</a>.</p>
            <p class="mb-3">BE COURTEOUS TO YOUR FELLOW COMPETITORS. AVOID SLOW PLAY and BE READY TO TEE OFF AT YOUR ASSIGNED TEE TIME. No one likes to have their tee time delayed or be held up while out on the course.</p>
            ...
            <p class="mb-3">The maximum allowed score for each hole is two more strokes than your opponent on that hole. If you pick up and concede the hole before you get on the green your opponent must be within the leather before his putt is good.</p>
            ...
            <p class="mb-3">Players are allowed four make-up matches during the season. Each match must be made up prior to the following week's matches and scorecards should be <a href="mailto:mccomas.chris@gmail.com">sent to the webmaster</a>. Opposing players are obligated to make every effort to accommodate the player who is missing the match. The proper handicap will be applied to the match that would be applied should the match be played at the scheduled date. If you pre-play a Thursday match and that regular Thursday match is rained out, your pre-play match is also considered rained out and is null and void.</p>
            <p class="mb-3">If during this time a player misses five matches he will be replaced immediately. The only exception to this rule is if a member has a medical situation.</p>
            <p class="mb-3">In the event of serious injury or illness, either to the player or a family member that needs their care, accommodations will be made to replace that player with a temporary player while his absence is required. Once the player is able to return to regular play, the temporary player will be released and the member will rejoin the League play.</p>
            <p class="mb-3">If a member of your foursome is not present at your appointed tee time, the next foursome will be allowed to tee off ahead of your group. Your foursome continues to get bumped back until your entire foursome is present. Once all of your group is present, you can tee off. If you know that you will not be able to play on a particular week, CALL YOUR TEAMMATES, YOUR OPPONENT, OR YOUR CAPTAIN and let them know. This saves us all time and trouble. Likewise, if you know that one of your group will not be present, your threesome can tee off at its appropriate time, assuming that all of you are there and ready to play.</p>
            ...
            <p class="mb-3">If a player is absent, his opponent automatically gets 1 point for showing up and playing and can win a 2nd point by beating or tying his partner's opponent. If neither opponent of one team shows up, the opponents that did show up receive two points each, but they must complete their round in order to receive the points. For example, if the number 1 and 2 players of Team 1 do not show up and their opponents on Team 2 do show up and play, both of the Team 2 players get 2 points. The same applies if all members of a team do not show up.</p>
        ...
        <div class="hidden lg:block lg:w-1/4 px-8 lg:sticky lg:top-0">
            <ul class="list-reset">
                <li class="mb-2"><a href="#membership" class="text-grey-dark hover:text-green">Membership &amp; Dues</a></li>
