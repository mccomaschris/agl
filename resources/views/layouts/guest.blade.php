...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-grey-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-grey-100">
            <div>
                <a href="/" class="inline-flex items-center">
					...
					<span class="font-semibold text-green-500 tracking-tight text-2xl">{{ config('app.name') }}</span>
				</a>
            </div>
