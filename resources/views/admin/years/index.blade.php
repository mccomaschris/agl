				...
				@forelse($years as $year)
						<tr class="hover:bg-zinc-100 focus-within:bg-zinc-lightest group text-zinc-500">
							<td class="border-t px-6 py-4  group-hover:text-green-500 ">
								<a href="/admin/years/{{ $year->id }}/edit" class="text-zinc-500">{{ $year->name }} Season</a>
							</td>
							<td class="border-t px-6 py-4 group-hover:text-green-500">
								@if($year->active)
							...
							<td class="border-t w-px">
								<a href="/admin/years/{{ $year->id }}/edit" class="text-zinc-500 group-hover:text-green-500 px-4">
