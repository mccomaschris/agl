...
@section('content')
	...
	<h1 class="mb-8 font-bold text-3xl">
		...
		<span class="text-zinc-700 font-medium">{{ $team->year->name }} Team {{ $team->name }}</span>
	</h1>
...
{{--
    <div class="w-full lg:w-2/3 bg-zinc-lightest mx-auto py-6 px-4 text-sm text-zinc-dark">
