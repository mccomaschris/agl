				...
				<div class="overflow-hidden ring-1 shadow-sm ring-black/5 rounded-lg">
					<table class="min-w-full divide-y divide-gray-300">
						<thead class="bg-zinc-50">
							<tr>
								<th scope="col" colspan="2" class="py-3.5 pr-3 text-left text-sm font-semibold text-zinc-900 pl-4">Team {{ $teamA->name }}</th>
								<th scope="col" colspan="2" class="px-3 py-3.5 text-left text-sm font-semibold text-zinc-900">Team {{ $teamB->name }}</th>
							</tr>
						</thead>
