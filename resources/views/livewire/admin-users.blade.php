	...
	<div class="px-4 sm:px-6 lg:px-8">
		<div class="flex items-center justify-between">
			<div class="sm:flex-auto">
				<h1 class="text-lg font-semibold leading-6 text-zinc-900">Users</h1>
			</div>
			...
			<div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
				<div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
					<table class="min-w-full divide-y divide-zinc-300">
						<thead>
							<tr>
								<th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-zinc-900 sm:pl-0">Name</th>
								<th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-zinc-900">Email</th>
								<th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-zinc-900">Phone #</th>
								<th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-zinc-900">Status</th>
								<th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-zinc-900">Admin</th>
						...
						<tbody class="divide-y divide-zinc-200">
							...
							<tr>
								<td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-semibold text-zinc-900 sm:pl-0">{{ $user->name }}</td>
								<td class="whitespace-nowrap py-4 px-3 text-sm text-zinc-500">{{ $user->email }}</td>
								<td class="whitespace-nowrap py-4 px-3 text-sm text-zinc-500">{{ $user->phone }}</td>
								<td class="whitespace-nowrap py-4 px-3 text-sm text-zinc-500 text-center">
									@if($user->active)
								...
								<td class="whitespace-nowrap py-4 px-3 text-sm text-zinc-500">@if($user->admin)<span class="text-green-500 font-semibold">Admin</span>@endif</td>
							...
							@empty
							<tr>
								<td colspan="6" class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-semibold text-zinc-900 sm:pl-0">No users found...</td>
							</tr>
							@endforelse
						</tbody>
					</table>
