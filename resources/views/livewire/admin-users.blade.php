					...
					<table class="min-w-full divide-y divide-gray-300">
						<thead>
							<tr>
								...
								<th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Admin</th>
						...
						<tbody class="divide-y divide-gray-200">
							...
							<tr>
								<td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-semibold text-gray-900 sm:pl-0">{{ $user->name }}</td>
								...
								<td class="whitespace-nowrap py-4 px-3 text-sm text-gray-500">@if($user->admin)<span class="text-green-500 font-semibold">Admin</span>@endif</td>
							...
							@empty
							<tr>
								<td colspan="6" class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-semibold text-gray-900 sm:pl-0">No users found...</td>
							</tr>
							@endforelse
						</tbody>
					</table>
