<div class="bg-grey-100 rounded py-6 px-6 my-6">
    <div class="flex space-x-6 items-center">
        ...
        <div>
            <div class="text-xs uppercase font-semibold text-grey-800">Push Future Weeks Back</div>
