	...
	<div class="px-4">
			...
			<div class="">
				...
				<ul class="list-group leading-normal">
					...
					@foreach ($members as $member)
						<li class="mb-2">
							<p class="font-semibold">{{ $member->name }} <span class="font-normal text-zinc-800">(Projected HC {{ $member->projected_hc }})</span></p>
							<p class="text-xs text-zinc-800">Added by {{ $member->user->name }}</p>
						</li>
					@endforeach
					@else
		...
		<div class="w-full lg:w-1/3 px-4">
			<div class="">
				...
				{{ csrf_field() }}
				<div class="mb-4">
					<label class="block text-zinc-800 text-sm font-semibold uppercase mb-2" for="name">
						Individual Name
					</label>
